...
echo -n "Did you grant Full Disk Access to the terminal??"
read x
...
defaults write NSGlobalDomain AppleLanguages -array "sk-SK" "en-SK"
defaults write NSGlobalDomain AppleLocale -string "sk_SK@currency=EUR"
...
defaults delete ~/Library/Preferences/com.apple.HIToolbox
defaults write com.apple.HIToolbox AppleCurrentKeyboardLayoutInputSourceID -string "com.apple.keylayout.US"
defaults write com.apple.HIToolbox AppleEnabledInputSources -array-add '<dict><key>InputSourceKind</key><string>Keyboard Layout</string><key>KeyboardLayout ID</key><integer>30777</integer><key>KeyboardLayout Name</key><string>Slovak</string></dict>'
...
# Open applications in tabs only in fullscreen
...
# (i.e. do not use the old Exposé behavior instead)
...
open "${PWD}/dotfiles/mac/iterm/Solarized Dark.itermcolors"
open "${PWD}/dotfiles/mac/iterm/dracula.itermcolors"
open "${PWD}/dotfiles/mac/iterm/Night Owl.itermcolors"
